...
public abstract class BasePreloadTableResolver
{
    ...
    /// <returns>A hashset of dependencies generated by this resolver.
    ...
    /// external is not present, it should be added.</returns>
    public abstract HashSet<PPtrInfo> BuildPreloadTable(long assetPathId, RepackingContext ctx);
}
